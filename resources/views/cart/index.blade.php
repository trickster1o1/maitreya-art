...
<div class="container">
    ...
    @if (count($items) < 1)
        <div align='center' style="padding-bottom: 20em;"><h2>There is currently {{$itemNo}} item(s) pending.</h2></div> 
    @else
    <table class="table">
        <thead>
          <tr>
    ...
    <div style="color: red; font-size:15pt;">There is currently {{$itemNo}} item(s) pending.</div>
    @endif
